...
const checkUpdate = async () => {
  await check()
    .then(async (e) => {
      ...
      // 检查版本之间不同的提交信息和提交日期
      const url = `https://gitee.com/api/v5/repos/weiyuim/weiyuim/releases/tags/v${newVersion.value}?access_token=${import.meta.env.VITE_GITEE_TOKEN}`
...
onMounted(async () => {
  ...
  const url = `https://gitee.com/api/v5/repos/weiyuim/weiyuim/releases/tags/v${currentVersion.value}?access_token=${import.meta.env.VITE_GITEE_TOKEN}`
