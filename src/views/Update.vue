...
// https://gitee.com/api/v5/repos/weiyuim/weiyuim/releases/tags/v${newVersion.value}?access_token=${import.meta.env.VITE_GITEE_TOKEN}
...
const fetchGiteeReleaseData = async (version: string) => {
  const apiEndpoint = new URL(`https://gitee.com/api/v5/repos/weiyuim/weiyuim/releases/tags/v${version}`)
